...
QT_MOC_LITERAL(1, 11, 15), // "showDigitResult"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 3), // "str"
QT_MOC_LITERAL(4, 32, 11), // "stdFileName"
QT_MOC_LITERAL(5, 44, 15) // "showGraphResult"

    },
    "ResultView\0showDigitResult\0\0str\0"
    "stdFileName\0showGraphResult"
};
...
void ResultView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ResultView *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->showDigitResult((*reinterpret_cast< str(*)>(_a[1]))); break;
        case 1: _t->showGraphResult((*reinterpret_cast< str(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
QT_INIT_METAOBJECT const QMetaObject ResultView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ResultView.data,
    qt_meta_data_ResultView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
